...
public class PictureShape extends ImageView {/**
...
public static final int TYPE_NONE = 0;
    ...
    public PictureShape(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.PictureShape);
        mType = ta.getInt(R.styleable.PictureShape_type, DEFAULT_TYPE);
        mBorderColor = ta.getColor(R.styleable.PictureShape_borderColor, DEFAULT_BORDER_COLOR);
        mBorderWidth = ta.getDimensionPixelSize(R.styleable.PictureShape_borderWidth, dip2px(DEFAULT_BORDER_WIDTH));
        mRectRoundRadius = ta.getDimensionPixelSize(R.styleable.PictureShape_rectRoundRadius, dip2px(DEFAULT_RECT_ROUND_RADIUS));
        ta.recycle();
    }
