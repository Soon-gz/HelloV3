        ...
        eventdetail_bt_cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isjoin_flag.equals("1")) {
                    ...
                    //参加活动弹出
                    EventBottomDialog.getEventJoinBottomDialog(bContext, null, new EventBottomDialog.onItemClickLitener() {
                        @Override
...
//            eventdetail_bt_cancel.setVisibility(View.VISIBLE);
    ...
    public void joinEvent(String a, String b) {
        presenter.isNotJoinEventAddNum(eventModel.getEventId() + "", isjoin_flag.equals("1") ? "0" : "1",a,b);
    }
}
