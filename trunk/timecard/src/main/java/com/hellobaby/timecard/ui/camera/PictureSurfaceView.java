...
public class PictureSurfaceView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public void resumeCamera() {
        ...
        int sW = 1280;
        int sH = 960;
        parameters.setPreviewSize(sW, sH);// 设置预览图片尺寸
//        parameters.setPreviewSize(largestSize.width, largestSize.height);// 设置预览图片尺寸
        ...
        parameters.setPictureSize(sW, sH);
//        parameters.setPictureSize(largestSize.width, largestSize.height);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        int height = 960;//MeasureSpec.getSize(heightMeasureSpec)/2;
        int width = 1280;//(int) (height*ratio);
