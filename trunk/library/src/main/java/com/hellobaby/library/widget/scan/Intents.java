...
public final class Intents {
  ...
  public static final class Scan {
    ...
    /**
     * Comma-separated list of formats to activity_capture for. The values must match the names of
    ...
    /**
     * Desired duration in milliseconds for which to pause after a successful activity_capture before
     ...
     * of the app which requested the activity_capture via
  ...
  public static final class Encode {
     ...
     * that another person can activity_capture the barcode from your screen.
     */
  ...
  public static final class Share {
     ...
     * display onscreen for a friend to activity_capture with their phone.
     */
