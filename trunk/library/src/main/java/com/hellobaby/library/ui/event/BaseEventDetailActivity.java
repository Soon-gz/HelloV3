...
//    public Button eventdetail_bt_join;
    ...
    protected void initViewsAndEvents(@Nullable Bundle savedInstanceState) {
        ...
        activityed_tv_kid = (TextView) findViewById(R.id.activityed_tv_kid);
        ...
        eventdetail_bt_joindetail = (Button) findViewById(R.id.eventdetail_bt_joindetail);
        eventdetail_bt_del = (Button) findViewById(R.id.eventdetail_bt_del);
//        eventdetail_bt_join=(Button) findViewById(R.id.eventdetail_bt_join);
    ...
    public void joinEvent(String a, String b) {
