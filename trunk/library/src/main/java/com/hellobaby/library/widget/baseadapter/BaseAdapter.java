...
public abstract class BaseAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public static final int TYPE_HEAD_VIEW = 100005;

    private OnLoadMoreListener mLoadMoreListener;
    private OnItemClickListeners<T> mItemClickListener;
    private OnItemLongClickListeners<T> mItemLongClickListener;

    protected Context mContext;
    protected List<T> mDatas;
    private boolean mOpenLoadMore;
    private boolean isAutoLoadMore = true;
    protected int mPosion;
    ...
    protected void convertHead(ViewHolder holder, T data,int position){}
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case TYPE_DEFAULT_VIEW:
                ...
                break;
            case TYPE_HEAD_VIEW:
                viewHolder = ViewHolder.create(mContext, getItemLayoutId(viewType), parent);
                break;
        }
        return viewHolder;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        switch (holder.getItemViewType()) {
            ...
            case TYPE_HEAD_VIEW:
                ...
                convertHead(viewHolder,mDatas.get(position),position);
                break;
        }
    }
