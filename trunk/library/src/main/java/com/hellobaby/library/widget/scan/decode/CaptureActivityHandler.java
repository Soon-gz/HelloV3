...
package com.hellobaby.library.widget.scan.decode;
...
import com.hellobaby.library.widget.scan.view.ViewfinderResultPointCallback;
...
public final class CaptureActivityHandler extends Handler {
    ...
    public void handleMessage(Message message) {
        ...
        if (what == R.id.restart_preview) {
            ...
            Log.d(TAG, "Got return activity_capture result message");
