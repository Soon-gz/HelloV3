...
public class ReviewsTypeActivity extends BaseTitleActivity implements ReviewsMvpView {
    ...
    private List<BabyAttendancesModel> babyAttendancesModels;
    ...
    protected void initViewsAndEvents(@Nullable Bundle savedInstanceState) {
        ...
        baseAdapter = new BaseAdapter<Item>(bContext, list, false) {
            ...
            protected void convert(ViewHolder holder, Item data) {
                ...
                if ("评语".equals(data.name)) {
                    ...
                    tvComplete.setText(data.isComplete() ? "已完成" : (completeCount + "/" + count));
                } else {
        ...
        baseAdapter.setOnItemClickListener(new OnItemClickListeners<Item>() {
            ...
            public void onItemClick(ViewHolder viewHolder, Item data, int position) {
                ...
                if ("评语".equals(data.name)) {
                    ...
                    intent.putParcelableArrayListExtra("BabyAttendancesModel", (ArrayList<? extends Parcelable>) babyAttendancesModels);
        ...
        presenter.selectLeaveByClassId(getIntent().getStringExtra("class"));
    }
    ...
    public void LeaveByClassId(List<BabyAttendancesModel> babyAttendancesModels) {
        this.babyAttendancesModels = babyAttendancesModels;
    }
