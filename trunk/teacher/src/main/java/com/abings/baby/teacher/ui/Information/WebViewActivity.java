                ...
                public void onClick(View v) {
                    BottomDialogUtils.getBottomListDialog(bContext, items, new BottomDialogUtils.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, String item, long id) {
                            ...
                            if(position==1) {
                                if (null != schoolItem) {
                                    ShareBottomDialog.getShareUrlBottomDialog(bContext, schoolItem.getListUrl().get(0), schoolItem.getNewsUrl(), "来自哈喽宝贝教师端", schoolItem.getName());
                                } else
                                    ShareBottomDialog.getShareUrlBottomDialog(bContext, informationModel.getNewInfoImageurls().split(",")[0], informationModel.getDetailsUrl(), "来自哈喽宝贝教师端", informationModel.getTitle());
                            }
                        }
                    });
                }
