...
public class AboutMeSchoolFragment extends BaseFragment {
    ...
    @BindView(R.id.aboutmeSchool_iv_classs)
    ...
    protected void initViewsAndEvents() {

        {
            ...
            if (ZSApp.getInstance().getClassModelList() != null){
                classModelList = ZSApp.getInstance().getClassModelList();
            }
    ...
    @OnClick({R.id.aboutmeSchool_tv_classs,R.id.aboutmeSchool_iv_classs})
...
//            tvClasss.setCompoundDrawables(null, null, drawable, null);
            ObjectAnimator oa=ObjectAnimator.ofFloat(classImageView, "rotation", 0,180);
            oa.setDuration(Const.ROAT_TIME);
            oa.start();
            listViewClass.setVisibility(View.VISIBLE);
        } else {
            ObjectAnimator oa=ObjectAnimator.ofFloat(classImageView, "rotation", 180,360);
            oa.setDuration(Const.ROAT_TIME);
            oa.start();
