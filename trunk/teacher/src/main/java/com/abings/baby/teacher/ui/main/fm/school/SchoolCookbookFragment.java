...
//        presenter.selectSchoolOnTeacher(Const.SCHOOL_COOKBOOK);
        pageModel = new PageModel();
    }
    @Override
    public void initListData() {
        pageModel = new PageModel();
        presenter.selectSchoolOnTeacherPage(Const.SCHOOL_COOKBOOK, pageModel.getPageNum());
    }
    @Override
        ...
        bAdapter.setOnLoadMoreListener(new OnLoadMoreListener() {
            ...
            public void onLoadMore(boolean isReload) {
                if (pageModel.getPageNum() != pageModel.getPages()){
                    presenter.selectSchoolOnTeacherPage(Const.SCHOOL_COOKBOOK, pageModel.getPageNum() + 1);
                }
                else{
