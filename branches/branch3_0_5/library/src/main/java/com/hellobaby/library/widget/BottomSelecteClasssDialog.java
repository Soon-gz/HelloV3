...
public class BottomSelecteClasssDialog extends BottomBaseDialog<BottomSelecteClasssDialog> {
    ...
    public View onCreateView() {
        ...
        View viewZhanWei =  view.findViewById(R.id.customSelectedClasss_view);
        View viewZhanWei2 =  view.findViewById(R.id.customSelectedClasss_view2);
        if(classModelList.size()<=1){
            viewZhanWei.setVisibility(View.VISIBLE);
            viewZhanWei2.setVisibility(View.VISIBLE);
        }else{
            viewZhanWei.setVisibility(View.GONE);
            viewZhanWei2.setVisibility(View.GONE);
        }
