...
import static com.sina.weibo.sdk.net.HttpManager.downloadFile;
...
public class SinglePhotoActivity extends BaseLibTitleActivity {
    ...
    protected void initViewsAndEvents(@Nullable Bundle savedInstanceState) {
        ...
        ImageLoader.loadHead(this, bmp, photo);
    }
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, String item, long id) {
                    if (position == 0) {
                        ...
                        if (bmp.equals( "")) {
                            ...
                            DownloadHelper.downloadFile(bmp, Const.saveImagePath, bmp.substring(bmp.lastIndexOf("/") + 1, bmp.length()))//
