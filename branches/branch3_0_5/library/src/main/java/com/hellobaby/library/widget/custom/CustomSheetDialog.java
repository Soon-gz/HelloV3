 ...
 */
public class CustomSheetDialog extends BottomBaseDialog<CustomSheetDialog> {
    /**
     * ListView
     */
    ...
    public CustomSheetDialog(Context context, ArrayList<DialogMenuItem> baseItems, View animateView) {
        super(context, animateView);
        mContents.addAll(baseItems);
        init();
    }

    public CustomSheetDialog(Context context, String[] items, View animateView) {
        super(context, animateView);
    ...
    public CustomSheetDialog(Context context, BaseAdapter adapter, View animateView) {
        super(context, animateView);
        mAdapter = adapter;
        init();
    }
     ...
     */
    public CustomSheetDialog titleBgColor(int titleBgColor) {
     ...
     */
    public CustomSheetDialog title(String title) {
        mTitle = title;
        return this;
    }
     ...
     */
    public CustomSheetDialog titleHeight(float titleHeight) {
     ...
     */
    public CustomSheetDialog titleTextSize_SP(float titleTextSize_SP) {
     ...
     */
    public CustomSheetDialog titleTextColor(int titleTextColor) {
     ...
     */
    public CustomSheetDialog isTitleShow(boolean isTitleShow) {
     ...
     * enable title show(设置标题是否显示)
     */
    public CustomSheetDialog isCancelShow(boolean isCancelShow) {
     ...
     */
    public CustomSheetDialog lvBgColor(int lvBgColor) {
     ...
     */
    public CustomSheetDialog cornerRadius(float cornerRadius_DP) {
     ...
     */
    public CustomSheetDialog dividerColor(int dividerColor) {
     ...
     */
    public CustomSheetDialog dividerHeight(float dividerHeight_DP) {
     ...
     */
    public CustomSheetDialog itemPressColor(int itemPressColor) {
     ...
     */
    public CustomSheetDialog itemTextColor(int itemTextColor) {
     ...
     */
    public CustomSheetDialog itemTextSize(float itemTextSize_SP) {
     ...
     */
    public CustomSheetDialog itemHeight(float itemHeight_DP) {
     ...
     */
    public CustomSheetDialog layoutAnimation(LayoutAnimationController lac) {
        mLac = lac;
        return this;
    }
     ...
     */
    public CustomSheetDialog cancelText(String cancelText) {
     ...
     * cancel btn text color(取消按钮文字颜色)
     */
    public CustomSheetDialog cancelText(int cancelTextColor) {
     ...
     * cancel btn text size(取消按钮文字大小)
     */
    public CustomSheetDialog cancelTextSize(float cancelTextSize) {
