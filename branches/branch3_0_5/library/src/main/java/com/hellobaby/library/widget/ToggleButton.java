...
//    private int onColor = Color.parseColor("#4ebb7f");
    private int onColor = Color.parseColor("#ffffff");
    /**
     * 关闭颜色
     */
//    private int offBorderColor = Color.parseColor("#dadbda");
    private int offBorderColor = Color.parseColor("#F2F2F2");
    /**
     * 灰色带颜色
     */
     ...
     * 圆圈颜色按下
     */
    private int buttonPressColor = Color.parseColor("#6EE8AF");
    ;
    /**
     * 圆圈颜色未按下
     */
    private int buttonUnPressColor = Color.parseColor("#D3D3D3");
    ;
    /**
     * 画笔
     */
...
//        typedArray.recycle();
    ...
    public void draw(Canvas canvas) {
        ...
        if (toggleOn)
            paint.setColor(buttonPressColor);
        else
            paint.setColor(buttonUnPressColor);
